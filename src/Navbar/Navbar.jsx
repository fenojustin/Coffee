              ...
              <div className='flex justify-between items-center ' data-aos="zoom-out" data-aos-duration="1000">
                  ...
                  <div>
                      <ul className=' hidden sm:flex  gap-2'>
                          {Menu.map((menu) => (
                              <li key={menu.id}>
                                  <a href={menu.link} className='inline-block py-4 px-4 hover:text-amber-500'>
                                    {menu.name}
                                  </a>
                              </li>
                          ))}
                  ...
                  <div className='hidden sm:flex '>
                      <input type="text" name="" id="" placeholder='Recherche' className='text-center rounded-full' />
                  </div>
              </div>
          </div>
      </div>
